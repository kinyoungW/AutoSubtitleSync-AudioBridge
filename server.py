...
HTML=r'''<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Auto Subtitle Sync v8.1</title>
<style>
...
</style></head><body><div class="shell"><div class="top"><div class="brand"><div class="logo">AS</div><div><h1>Auto Subtitle Sync</h1><div class="sub">本地字幕 · 翻译 · 校准 · Look-ahead 在线字幕</div></div></div><div class="ver">v8.1 · Audio Bridge</div></div><div class="grid"><main>
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        if u.path=='/api/companion/ping':
            self.send_json({'ok':True,'app':'AutoSubtitleSync','version':'8.1','port':self.server.server_port}); return
...
if __name__=='__main__':
    ...
    print('\nAuto Subtitle Sync v8.1 · 音频桥 + Iframe Bridge 已启动')
    print('本地地址：',url)
